...
RegisterNetEvent('ALPHAFW:Client:OnPlayerUnload')
AddEventHandler('ALPHAFW:Client:OnPlayerUnload', function()
    isLoggedIn = false
	QBHud.Show = false
end)

RegisterNetEvent('ALPHAFW:Client:OnPlayerLoaded')
AddEventHandler('ALPHAFW:Client:OnPlayerLoaded', function()
    isLoggedIn = true
	QBHud.Show = true
end)
